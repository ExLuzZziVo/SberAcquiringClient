...
namespace SberAcquiringClient.Resources {
    ...
    public class ErrorStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Любое из следующих полей должно быть заполнено: &apos;Идентификатор заказа в платежной системе&apos;, &apos;Идентификатор заказа в системе продавца&apos;, &apos;Идентификатор чека в фискализаторе&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to В настройках API должен быть заполнен адрес хоста и логин/пароль или токен.
        /// </summary>
