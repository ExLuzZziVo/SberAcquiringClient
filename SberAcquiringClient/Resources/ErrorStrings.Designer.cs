...
namespace SberAcquiringClient.Resources {
    ...
    public class ErrorStrings {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Любое из следующих полей должно быть заполнено: &apos;Идентификатор заказа в платежной системе&apos;, &apos;Идентификатор заказа в системе продавца&apos;, &apos;Идентификатор чека в фискализаторе&apos;.
        /// </summary>
